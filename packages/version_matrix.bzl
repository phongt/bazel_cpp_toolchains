...
VERSION_MATRIX = {
    ...
    "x86_64-linux-yocto": {
        ...
        "extra_link_flags": [
            ...
            "-Wl,-z,relro,-z,now",
            # "-B",
            # "external/%{toolchain_pkg}%/sysroots/core2-64-poky-linux/usr/bin",
            # "-fuse-ld=bfd",
            # "-L",
            # "external/%{toolchain_pkg}%/sysroots/core2-64-poky-linux/lib",
            # "-L",
            # "external/%{toolchain_pkg}%/sysroots/core2-64-poky-linux/usr/lib",
            "-lm",
            "-ldl",
            "-lrt",
            "-lstdc++",
